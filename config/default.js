			...
			registrations: [{
				...
				plugin: {
					...
					options: {
						...
						info: {
							title: 'scaffold-js-sample-app API',
							description: 'scaffold-js generated application',
							/* termsOfService: '', */
							contact: {
								name: 'scaffold-js',
								email: 'admin@scaffold-js.org'
							},
							license: {
								name: 'MIT',
...
//						},
		...
		db: {
			url: 'mongodb://localhost:27017/scaffold-js-sample-app'
		},
		web: {
			content: './src/web',
