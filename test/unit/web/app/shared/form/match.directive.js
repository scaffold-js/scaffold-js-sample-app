(function matchDirectiveTests () {
	...
	describe ('match directive', function matchDirective () {
		beforeEach (function beforeEach () {
			...
			this.$compile (angular.element ('<form name="form"><input name="other" ng-model="other" /><input scaffold-js-sample-app-match="other" name="match" ng-model="match" /></form>')) (this.$rootScope);
