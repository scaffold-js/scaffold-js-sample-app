(function passwordDirective () {
	...
	angular.module ('scaffold-js-sample-app').directive ('scaffoldJsSampleAppPasswordStrength', function passwordStrength () {
		return {
			restrict: 'E',
			replace: true,
	...
	}).directive ('scaffoldJsSampleAppPasswordValid', function passwordValidDirective () {
		return {
			restrict: 'A',
			require: 'ngModel',
